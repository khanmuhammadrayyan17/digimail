...
export default function Home() {
  ...
  return (
    <div className={`max-sm:w-screen flex flex-col justify-center items-center px-5 py-10 bg-gradient-to-br from-indigo-500 to-purple-600 ${emailSummary?.summary || error ? 'h-full' : 'h-screen'}`}>
